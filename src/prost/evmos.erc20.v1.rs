...
pub mod msg_client {
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + Send,
    {
        ...
        pub async fn convert_coin(
            ...
            let path = http::uri::PathAndQuery::from_static("/evmos.erc20.v1.Msg/ConvertCoin");
        ...
        pub async fn convert_erc20(
            ...
            let codec = tonic::codec::ProstCodec::default();
            let path = http::uri::PathAndQuery::from_static("/evmos.erc20.v1.Msg/ConvertERC20");
            self.inner.unary(request.into_request(), path, codec).await
        }
    }
}
...
pub mod query_client {
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + Send,
    {
        ...
        pub async fn token_pairs(
            ...
            let codec = tonic::codec::ProstCodec::default();
            let path = http::uri::PathAndQuery::from_static("/evmos.erc20.v1.Query/TokenPairs");
            self.inner.unary(request.into_request(), path, codec).await
        }
        ...
        pub async fn token_pair(
            ...
            let codec = tonic::codec::ProstCodec::default();
            let path = http::uri::PathAndQuery::from_static("/evmos.erc20.v1.Query/TokenPair");
            self.inner.unary(request.into_request(), path, codec).await
        }
        ...
        pub async fn params(
            ...
            let codec = tonic::codec::ProstCodec::default();
            let path = http::uri::PathAndQuery::from_static("/evmos.erc20.v1.Query/Params");
            self.inner.unary(request.into_request(), path, codec).await
        }
    }
}
